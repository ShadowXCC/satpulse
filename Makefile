...
ARCH:=$(shell uname -m)
MAN_PAGES=satpulsetool.1 satpulsetool-gps.1 satpulsetool-pack.1 satpulsetool-satellites.1 satpulsetool-scan.1 satpulsetool-sdp.1 satpulsetool-syncsim.1 satpulsetool-convobs.1 satpulse.toml.5 satpulsed.8
...
install: out/$(GOARCH)/satpulsed out/$(GOARCH)/satpulsetool out/$(GOARCH)/satpulse.toml $(MAN_TARGETS) gpsmsg
	...
	install -D -m 644 out/satpulsetool-satellites.1 /usr/local/share/man/man1/satpulsetool-satellites.1
...
uninstall:
	...
	rm -f /usr/local/share/man/man1/satpulsetool-satellites.1
...
$(DEB_PATTERN): % out/%/satpulse.toml $(MAN_GZ_TARGETS) gpsmsg
	...
	install -D -m 644 out/satpulsetool-satellites.1.gz out/$*/deb/usr/share/man/man1/satpulsetool-satellites.1.gz
